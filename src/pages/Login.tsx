...
const Login = () => {
    ...
    return (
      <div className={`bg-[url("https://assets.prebuiltui.com/images/components/hero-section/hero-background-image.png")] bg-cover bg-center bg-no-repeat bg-black text-white flex items-center pb-10 items-center justify-center min-h-screen` }>
           <form
            onSubmit={handleSubmit}
            className="sm:w-87.5 w-full items-center text-center bg-gray-900 border border-gray-800 rounded-2xl px-8">
            ...
            <button type="submit" className="mt-2 w-full h-11 rounded-full text-white bg-gradient-to-r from-[#4F39F6] to-[#FDFEFF] hover:bg-indigo-500 transition " >
                {state === "login" ? "Login" : "Sign up"}
            </button>
