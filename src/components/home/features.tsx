...
const Features = () => {
    ...
    const CreateCard = (cardsData:{image:string,name:string, handle:string}) => (
        <div className="p-4 rounded-lg mx-4 shadow hover:shadow-lg transition-all duration-200 w-72 shrink-0">
            <div className="flex gap-2">
                <img className="size-11 rounded-full" src={cardsData.image} alt="User Image" />
                <div className="flex flex-col">
                    ...
                    <span className="text-xs text-slate-500">{cardsData.handle}</span>
                </div>
            </div>
    ...
    return (
        <>
            <div className="flex flex-col md:flex-row items-center justify-center bg-white/50">
        ...
        `}</style>
            ...
            <div className="marquee-row w-full mx-auto max-w-5xl overflow-hidden relative">
                <div className='text-center'>
                    <h1 className="text-3xl md:text-4xl font-bold text-gray-800">What Our User Say</h1>
